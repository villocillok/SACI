<?php
    ...
    class PDF_Generate_Acquisition_Of_Materials_Report extends PDF_MC_Table {
        public $dateRange = '';
        public $printedBy = '';
        ...
        function Header() {
            ...
            if($this->PageNo() == 1) {
                ...
                $this->Cell(0, 5, 'Acquisition of books Report', 0, 0, 'L');
				$this->Ln();//added
            ...
            $this->SetTextColor(25, 40, 35);
            $this->SetAligns(array('C', 'C', 'C', 'C', 'C', 'C', 'C','C','C','C')); #Original, there are only 8 Cs. There should be 11.
            $this->SetWidths(array(25, 30, 20, 20, 20, 30, 25, 25, 25, 25));
            $this->Row(array( 'Publisher', 'Section', 'Book Title', 'Call Number', 'Edition', 'Year Published','Quantity','Unit of price', 'Author(s)', 'Category'));

...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2019 at 12:00 AM
...
(1, '2 25866 680 0', 1, '1'),
(2, '1 70129 951 0', 1, 'true'),
(3, '8 18944 171 0', 1, 'true'),
(4, '4 69980 660 9', 1, '1'),
(5, '0 36840 409 3', 1, '1'),
(6, '6 04175 723 0', 1, '1'),
(7, '4 79854 959 6', 1, '1'),
...
(19, '5 28866 676 3', 1, 'true'),
(20, '4 10510 191 6', 1, '1'),
(21, '7 15341 524 0', 1, 'true'),
...
(6, 9, 3, 'Living, Loving & Learning', '', 'First', 1982, 1, '', 'active', '', 3, '2018-09-22'),
...
(21, 22, 3, '48 Laws Of Power', '', 'Third', 2000, 0, '', 'active', '', 3, '2018-09-22'),
(22, 2, 3, 'C2', '123', 'Second', 2016, 1, '', 'active', '', 2, '2018-09-22'),
...
(11111, 0, '', '', '', '', '', '', NULL, '', '5f4dcc3b5aa765d61d8327deb882cf99', NULL),
(123456, 3, 'l', 'l', 'l', '123', 'Male', 'College Student', NULL, 'Bachelor of Science in Nursing', '5f4dcc3b5aa765d61d8327deb882cf99', NULL),
...
--
ALTER TABLE `borrow`
  MODIFY `Borrow_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
--
-- AUTO_INCREMENT for table `borrow_details`
--
ALTER TABLE `borrow_details`
  MODIFY `Borrow_Details_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
